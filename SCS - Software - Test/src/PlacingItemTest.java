...
public class PlacingItemTest {
	...
	public void setUp() {
		...
		item2 = new BarcodedItem(bc2, 31.99);
	}
	...
	// Test getLastWeight function and situation a item add in
	@Test
	...
	// Situation add two item and the second one is overload
	@Test
	...
	// Situation weight on the scale is not same as expected item value
	@Test
	public void testCheckAdd2() {
		...
		ItemProductPair pair2 = new ItemProductPair(item2, prod2);
		cart.addToCart(pair2);
		BarcodedItem item3 = new BarcodedItem(bc2, 23);
	...
	// Test lastWeight is two items added up
	@Test
	...
	// Test the scanner is enable after item added
	@Test
